...
void ApplicationCommonWindow::createStandardOperations() {
    ...
    fileNewAction = new QAction(newIcon, QObject::tr("NEW"), this);
    ...
    fileCloseAction = new QAction(closeIcon, QObject::tr("CLOSE"), this);
    ...
    filePrefUseVBOAction = new QAction(QObject::tr("USE_VBO"), this);
    ...
    viewToolAction = new QAction(QObject::tr("TOOL_BAR"), this);
    ...
    viewStatusAction = new QAction(QObject::tr("STATUS_BAR"), this);
    ...
    helpAboutAction = new QAction(helpIcon, QObject::tr("ABOUT"), this);
    ...
    myFilePopup = menuBar()->addMenu(QObject::tr("FILE"));
...
void ApplicationCommonWindow::createCasCadeOperations() {
    ...
    a = new QAction(QPixmap(dir + QObject::tr("ICON_TOOL_WIRE")), QObject::tr("TOOL_WIRE"), this);
...
void ApplicationCommonWindow::windowsMenuAboutToShow() {
    ...
    a = new QAction(QPixmap(dir + QObject::tr("ICON_WINDOW_NEW3D")), QObject::tr("WINDOW_NEW3D"), this);
    ...
    a = new QAction(QPixmap(dir + QObject::tr("ICON_WINDOW_CASCADE")), QObject::tr("WINDOW_CASCADE"), this);
    ...
    a = new QAction(QPixmap(dir + QObject::tr("ICON_WINDOW_TILE")), QObject::tr("WINDOW_TILE"), this);
...
void ApplicationCommonWindow::closeEvent(QCloseEvent *event) {
    if (!myDocuments.isEmpty()) {
        // if #sub-window is more than 0 close them properly
        while (myDocuments.size()) {
            QList<DocumentCommon *>::iterator x;
            x = myDocuments.begin();
            onCloseDocument(x.i->t());
        }
    }
}
